...
namespace EasyImGui
{
    public class CustomImGuiForm : D3D9Window, IDisposable
    {

        [DllImport("user32.dll")]
        static extern bool ShowWindow(IntPtr hWnd, int nCmdShow);

        public event RenderUI_EventHandler ConfigFlags = delegate {
            return true;
        };
        ...
        public CustomImGuiForm() : base(true, true)
        {
            this.AutoReset = true;
        ...
        public CustomImGuiForm(bool Transparent = true, bool Clickable = true) : base(Transparent, Clickable)
        {
            this.AutoReset = true;
            this.Fix_WM_NCLBUTTONDBLCLK = false;
            this.Text = "EasyImgui";
